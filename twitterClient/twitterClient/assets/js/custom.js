...
****************************************************/
//  COMMENT 
jQuery('#tweets-container').bind('inview', function (event, visible) {
        if (visible == true) {
            jQuery('.tweet').addClass("animated bounceInLeft");
        } else {
            jQuery('.tweet').removeClass("animated bounceInLeft");

            //jQuery('.effect-box').unbind('inview');
        }
    });

jQuery('.team').bind('inview', function (event, visible) {
        if (visible == true) {
            jQuery('.team-item').addClass("animated bounceIn");
        } else {
            jQuery('.team-item').removeClass("animated bounceIn");
